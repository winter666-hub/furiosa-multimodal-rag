...
class Settings:
    ...
    def from_env(cls, dotenv_path: str | Path = ".env") -> Settings:
        ...
        endpoints = (
            ModelEndpoint(
                "llm",
                os.getenv("FURIOSA_LLM_BASE_URL", "https://endpoint.access.furiosa.dev/v1"),
                os.getenv("FURIOSA_LLM_MODEL", "furiosa-ai/Qwen3-32B-FP8"),
            ),
            ModelEndpoint(
                "vision",
                os.getenv("FURIOSA_VISION_BASE_URL", "https://endpoint.access.furiosa.dev/v1"),
                os.getenv("FURIOSA_VISION_MODEL", "furiosa-ai/Qwen3-VL-32B-Instruct"),
            ),
            ModelEndpoint(
                "embedding",
                os.getenv("FURIOSA_EMBEDDING_BASE_URL", "https://endpoint.access.furiosa.dev/v1"),
                os.getenv("FURIOSA_EMBEDDING_MODEL", "furiosa-ai/Qwen3-Embedding-8B"),
            ),
            ModelEndpoint(
                "reranker",
                os.getenv("FURIOSA_RERANKER_BASE_URL", "https://endpoint.access.furiosa.dev/v1"),
